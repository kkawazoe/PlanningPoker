...
class PointsControllerTest < ActionController::TestCase
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post :create, point: { group_id: @point.group_id, member_id: @point.member_id, value: @point.value }
    end
  ...
  test "should update point" do
    put :update, id: @point, point: { group_id: @point.group_id, member_id: @point.member_id, value: @point.value }
    assert_redirected_to point_path(assigns(:point))
  end
